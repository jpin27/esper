...
export class HomePage {
	...
	// Imgur client ID
	public IMGUR_CLIENT_ID:string = "7de550891e63acf";
	...
	// Azure Face API key
	public AZURE_API_KEY:string = "abc981cb2ce64513b437f694e2c83168";
	...
	/* Inject the Camera provider through the homepage's constructor. */
	/* This enables us to use the camera using the variable camera. */ 
